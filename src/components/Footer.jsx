...
export default function Footer() {
  const quickLinks = [
    ...
    { label: "CATEGORY", href: "#category", icon: <MdOutlineCategory /> },
  ...
  return (
    <footer className="bg-gradient-to-r from-green-600 to-green-800 text-white py-10 px-5 md:px-12 lg:px-24">
      <div className="grid md:grid-cols-3 md:gap-48 lg:gap-56">
        ...
        <div className="flex flex-col space-y-2 md:min-w-88 lg:min-w-96">
          ...
          <div className="flex items-center space-x-2">
            ...
            <p className="text-sm">info@axisinternationalexports.com</p>
          </div>
          <div className="flex items-center space-x-2 mt-1 md:mt-2">
            <FaPhone className="text-xl" />
            <p className="text-sm">+91 7985538177</p>
          </div>
        </div>
