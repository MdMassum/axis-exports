    ...
    <section className=" py-10 md:pt-24 px-4 -mb-10 overflow-x-hidden " id="aboutUs">
      <div className="mx-auto">
        ...
        {/* Background Image with Enhanced Visibility */}
          ...
          {/* <div
            className="relative z-10 bg-center bg-no-repeat -mx-4"
            style={{
          ...
          > */}
            <div className="relative z-20 md:w-[90%] mx-auto">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center -space-y-4 md:space-y-0 md:gap-8 mb-10">
                <InfoCard
                  title="Our Mission"
              ...
              <div className="relative rounded-md py-2 md:pt-16">
                ...
                <a href="/enquiry" className="w-full md:w-48 flex justify-center md:absolute md:bottom-6 md:right-0 mr-24">
                  <Button />
                </a>
              </div>
            </div>
