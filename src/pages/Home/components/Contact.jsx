...
const Contact = () => {
  return (
    <div id="contactUs" className="w-full md:w-[85%] flex flex-col md:flex-row mx-auto p-5 md:p-0  justify-between md:gap-32 gap-8 md:py-16 bg-white rounded-lg ">
      {/* Logo Section */}
      ...
      <div className="w-full md:w-1/2 text-green-800 text-left">
        <div className="w-full flex items-center mb-7 md:mb-16">
          <div className="flex flex-row md:flex-col items-center justify-center md:gap-0 font-bold md:-ml-6">
            <h2 className="text-6xl md:text-8xl text-left min-w-56">Get in</h2>
            <h2 className="text-lime-600 text-6xl md:-mt-2 md:text-7xl -ml-14 md:-ml-6">touch!</h2>
          </div>
