  ...
  return (
    <section id="home" className="bg-green-700 relative text-white pt-20">
      <div className="w-full mx-auto flex md:items-center md:justify-center pl-2  md:mt-0 md:px-0">
        {/* Left Content */}
        <div className="w-full md:w-1/2 mt-6 md:mt-0 md:pl-28 z-20 text-center md:text-left">
          <h1 className="text-6xl md:text-6xl font-bold mb-1">
            Herbal &
          </h1>
          <h1 className="text-5xl md:text-6xl font-bold mb-1 min-w-56">
            Organic Product
          </h1>
      ...
      <div className="flex flex-wrap bg-white text-black py-5 md:py-7 pl-4 md:pl-24 text-sm font-semibold md:rounded-r-4xl z-30">
